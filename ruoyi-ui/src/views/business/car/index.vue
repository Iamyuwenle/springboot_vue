    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="车牌号">
          <imageUpload v-model="form.carNumber"/>
        </el-form-item>
        <el-form-item label="车架号" prop="frameNumber">
...
:value="dict.value"
        ...
        <el-form-item label="出租状态" prop="status">
          <el-select v-model="form.status" placeholder="请选择出租状态">
            <el-option
              v-for="dict in dict.type.car_rent_status"
              :key="dict.value"
              :label="dict.label"
:value="parseInt(dict.value)"
        ...
        <el-form-item label="车辆所属门店" prop="deptId">
          <el-input v-model="form.deptId" placeholder="请输入车辆所属门店" />
        </el-form-item>
      </el-form>
